...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '林本兔', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '来自鬼畜区的科技区博主', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.linbentu.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,林本兔', // 网站关键词 英文逗号隔开
